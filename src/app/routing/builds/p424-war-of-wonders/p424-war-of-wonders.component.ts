...
export class P424WarOfWondersComponent implements OnInit {
    ...
    build: string = "Most wonder rallies are in a ranged phalanx, or ranged wedge. This leads to 424 or other equipment builds and formations that focus on infantry and cavalry to heavily outperform ranged builds on average. The focus of this build is to clear the opponent's frontline ranged troops with your infantry and then leave the remaining opponent infantry/cavalry for your cavalry and ranged.";

    notes: string = "This build is especially effective because most rally leads with mythic monster gear will have heavier ranged and infantry stats with ambrosial cups, blight rings, skullcrusher, and dragon talon boots. A heavy infantry/cavalry build will dominate the competition until the opponent rally lead breaks into half champion gear or above.";

    strongAgainst: string[] = ['244', '424 of Lower Stats', '111 Even Mix'];
    weakAgainst: string[] = ['442', '001 Cavalry Blast if taken in infantry phalanx'];
